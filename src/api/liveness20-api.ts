...
export const Liveness20ApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        deleteLivenessTransaction: async (transactionId: string, tag: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const Liveness20ApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteLivenessTransaction(transactionId: string, tag: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
...
export const Liveness20ApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteLivenessTransaction(transactionId: string, tag: string, options?: any): AxiosPromise<void> {
...
export class Liveness20Api extends BaseAPI {
     ...
     */
    public deleteLivenessTransaction(transactionId: string, tag: string, options?: AxiosRequestConfig) {
