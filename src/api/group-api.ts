    ...
    */
    ...
    return {
        ...
        * 
            ...
            * @param {number} groupId Group id
            * @param {GroupToCreate} groupToCreate Metadata
        * @param {*} [options] Override http request option.
        * @throws {RequiredError}
        */
        updateGroup: async (groupId: number, groupToCreate: GroupToCreate, options: any = {}): Promise<RequestArgs> => {
                    // verify required parameter 'groupId' is not null or undefined
                    if (groupId === null || groupId === undefined) {
                    ...
                    // verify required parameter 'groupToCreate' is not null or undefined
                    if (groupToCreate === null || groupToCreate === undefined) {
                    throw new RequiredError('groupToCreate','Required parameter groupToCreate was null or undefined when calling updateGroup.');
                    }
            const localVarPath = `/api/groups/{group_id}`
                .replace(`{${"group_id"}}`, encodeURIComponent(String(groupId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        */
        ...
        return {
            ...
            * @throws {RequiredError}
            */
            async updateGroup(groupId: number, groupToCreate: GroupToCreate, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await GroupApiAxiosParamCreator(configuration).updateGroup(groupId, groupToCreate, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
            const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
            return axios.request(axiosRequestArgs);
            };
        ...
        */
        ...
        updateGroup(groupId: number, groupToCreate: GroupToCreate, options?: any): AxiosPromise<void> {
            return GroupApiFp(configuration).updateGroup(groupId, groupToCreate, options).then((request) => request(axios, basePath));
            },
            /**
            * 
                * @summary Add/remove persons to group
        ...
        */
            ...
            * @memberof GroupApi
            */
                protected updateGroupGen(groupId: number, groupToCreate: GroupToCreate, options?: any) {
