 ...
 */
    ...
    */
    ...
    return {
        ...
        * @throws {RequiredError}
        */
        updatePerson: async (personId: number, personFields: PersonFields, options: any = {}): Promise<RequestArgs> => {
                    // verify required parameter 'personId' is not null or undefined
                    if (personId === null || personId === undefined) {
                    ...
                    // verify required parameter 'personFields' is not null or undefined
                    if (personFields === null || personFields === undefined) {
                    throw new RequiredError('personFields','Required parameter personFields was null or undefined when calling updatePerson.');
                    }
            const localVarPath = `/api/persons/{person_id}`
                .replace(`{${"person_id"}}`, encodeURIComponent(String(personId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
        ...
        */
        ...
        return {
            ...
            * @throws {RequiredError}
            */
            async addImageToPerson(personId: number, inlineObject: InlineObject, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Image>> {
            ...
            * @throws {RequiredError}
            */
            async updatePerson(personId: number, personFields: PersonFields, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            const localVarAxiosArgs = await PersonApiAxiosParamCreator(configuration).updatePerson(personId, personFields, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
            const axiosRequestArgs = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
            return axios.request(axiosRequestArgs);
            };
        ...
        */
        ...
        return {
            ...
            * @throws {RequiredError}
            */
        addImageToPerson(personId: number, inlineObject: InlineObject, options?: any): AxiosPromise<Image> {
        ...
        updatePerson(personId: number, personFields: PersonFields, options?: any): AxiosPromise<void> {
            return PersonApiFp(configuration).updatePerson(personId, personFields, options).then((request) => request(axios, basePath));
            },
        };
        };
        ...
        */
            ...
            * @memberof PersonApi
            */
                protected updatePersonGen(personId: number, personFields: PersonFields, options?: any) {
