    ...
    */
    ...
    return {
        ...
        * 
            ...
            * @param {Model1persons1personId1images} body Image to add
        * @param {*} [options] Override http request option.
        * @throws {RequiredError}
        */
        addImageToPerson: async (personId: number, body: Model1persons1personId1images, options: any = {}): Promise<RequestArgs> => {
                    ...
                    throw new RequiredError('body','Required parameter body was null or undefined when calling addImageToPerson.');
                    }
        ...
        */
        ...
        return {
            ...
            * @throws {RequiredError}
            */
            async addImageToPerson(personId: number, body: Model1persons1personId1images, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Model1persons1personId1images>> {
            const localVarAxiosArgs = await PersonApiAxiosParamCreator(configuration).addImageToPerson(personId, body, options);
        ...
        */
        ...
        return {
            ...
            * @throws {RequiredError}
            */
        addImageToPerson(personId: number, body: Model1persons1personId1images, options?: any): AxiosPromise<Model1persons1personId1images> {
            return PersonApiFp(configuration).addImageToPerson(personId, body, options).then((request) => request(axios, basePath));
            },
            /**
            * 
                * @summary Create person
        ...
        */
            ...
            * @memberof PersonApi
            */
                protected addImageToPersonGen(personId: number, body: Model1persons1personId1images, options?: any) {
                return PersonApiFp(this.configuration).addImageToPerson(personId, body, options).then((request) => request(this.axios, this.basePath));
                }
